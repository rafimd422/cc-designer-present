...
const ccOffecial = [
  {
    name: "Fahim Ahmed",
    authorImg:
      "https://i.ibb.co/JsCkgJQ/399405602-1476492643145139-5022415993902421846-n.jpg",
  ...
  },
  {
    ...
    authorImg:
      "https://i.ibb.co/qyBn1L4/409629996-1295923168469413-6260810901574003843-n.jpg",
  ...
  },
  {
    name: "Jayed Iqbal",
    authorImg:
      "https://i.ibb.co/10spY3t/404790164-387016697089188-8115947067666486852-n.jpg",
...
const culturalEventChallenge = [
  {
    ...
    theme:
      "Simple and Clean with the combination of Yellow and Green and Bangladesh`s cultural Colours for background",
  },
  {
    name: "Omar Fahmid Khan",
    authorImg:
...
const socialMediaCampaign = [
  {
    ...
    authorImg:
      "https://i.ibb.co/qyBn1L4/409629996-1295923168469413-6260810901574003843-n.jpg",
    design:
      'https://i.ibb.co/WpBrBSW/20240112-210506-0000.jpg" alt="20240112-210506-0000',
    title: "",
    theme: "No title and theme is provided",
  },
  {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col text-start justify-start container mb-6 md:px-8">
        <h3 className="font-bold text-2xl">Category 1: CC OFFICIAL 222</h3>
        <p className="text-sm">
      ...
      <div className="flex flex-wrap md:container mx-auto gap-6 justify-center">
        {ccOffecial.map((socialMedia) => (
          <Card1 key={socialMedia?.name} social={socialMedia} />
        ))}
      </div>

      <div className="flex flex-col text-start justify-start container mb-6 md:px-8">
        <h3 className="font-bold text-2xl">
          Category 2: Cultural Event Challenge
        </h3>
        <p className="text-sm">
          Here our designers created a vibrant and captivating poster for a
          multicultural event featuring music, art etc
        </p>
      </div>

      <div className="flex flex-wrap md:container mx-auto gap-6 justify-center md:px-8">
        {culturalEventChallenge.map((socialMedia) => (
          <Card2 key={socialMedia?.name} social={socialMedia} />
        ))}
      </div>

      <div className="flex flex-col text-start justify-start container mb-6">
        <h3 className="font-bold text-2xl">
          Category 3: Social Media Campaign Challenge
        </h3>
        <p className="text-sm">
          Here our designers designed a banner for a collaborative Campaign with
          `the daily star` on the topic of pohela boishash
        </p>
      </div>
      <div className="flex flex-wrap md:container mx-auto gap-6 justify-center">
        {socialMediaCampaign.map((socialMedia) => (
          <Card3 key={socialMedia?.name} social={socialMedia} />
        ))}
      </div>
    </main>
  );
